	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Questionnaire->save($this->request->data)) {
				$this->Session->setFlash('The questionnaire has been saved.', 'alert-box', array('class'=>'alert-danger'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('The questionnaire could not be saved. Please, try again.', 'alert-box', array('class'=>'alert-danger'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Questionnaire->delete()) {
			$this->Session->setFlash('The questionnaire has been deleted.', 'alert-box', array('class'=>'alert-danger'));
		} else {
			$this->Session->setFlash('The questionnaire could not be deleted. Please, try again.', 'alert-box', array('class'=>'alert-danger'));
		}
		return $this->redirect(array('action' => 'index'));
	}
