	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Description->save($this->request->data)) {
				$this->Session->setFlash(__('The description has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The description could not be saved. Please, try again.'));
			}
		}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Description->delete()) {
			$this->Session->setFlash(__('The description has been deleted.'));
		} else {
			$this->Session->setFlash(__('The description could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}}
