<div class="container nowrap">
	...
	<?php
		...
		echo "<a href=http://hashkit.localhost/Pages/hash_function><u>here.</u></a><br>";
	?>
	<hr>
	...
	echo '<br><br>Flipping a single bit on the input word "Hello" causes <b>'. $output[3]['Percent']. '%</b> changes in output bits.';
	?>

	<br><br><hr>
	<div class="subHeader" style="font-size:150%">
		<?php
		echo 'More examples below...';
		?>
	</div>
	<hr><br>
	...
	echo '<br><br>Flipping a single bit on the input word "Computer" causes <b>'. $output[6]['Percent']. '%</b> changes in output bits.';
	?>
