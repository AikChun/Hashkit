<div class="dictionaries index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('md5digest'); ?></th>
			<th><?php echo $this->Paginator->sort('sha1digest'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($dictionaries as $dictionary): ?>
	<tr>
		<td><?php echo h($dictionary['Dictionary']['id']); ?>&nbsp;</td>
		<td><?php echo h($dictionary['Dictionary']['plaintext']); ?>&nbsp;</td>
		<td><?php echo h($dictionary['Dictionary']['md5digest']); ?>&nbsp;</td>
		<td><?php echo h($dictionary['Dictionary']['sha1digest']); ?>&nbsp;</td>
		<td class="actions">
