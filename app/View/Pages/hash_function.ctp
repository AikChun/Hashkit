<article class="container">
        <div class="row">
          ...
          <div class="col-md-9">
              ...
              <br>
              Despite of having the same functionality as a hash function, it has additional properties such one-way which provides better security. It is usually associated with generating a message digest(sometimes mentioned in some article, as checksum) which is normally shorter than the original data and does not any relations with the original data instead of a hash value.
              <br>
