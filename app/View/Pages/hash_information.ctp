        ...
        <div class="row">
          ...
          <div class="col-md-9">
              ...
              <hr class="">
                ...
                <br>
                <h4>Meet-in-the-Middle attack</h4>
                <p>
                This attack can allow to rapidly reduce the number of brute force permutations  required to decrypt text that has been encrypted(hash in our case) by more than 
                one key.Since the hash functions are designed to use block ciphers, the attack will be applying brute force techiques to both the plaintext and message digest of a single block by during first round of hashing, the attacker will attempt to hash the plaintext with various keys to achieve an immediate .
                </p>
                <br>
